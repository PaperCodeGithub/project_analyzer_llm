...
#####
print(f"{Fore.LIGHTBLUE_EX}Welcome to the Project Analyzer!{Style.RESET_ALL}")
...
def main():
    ...
    try:
        retrieval_chain = scan_and_load_codebase(path=path, model="qwen3-coder:480b-cloud")
